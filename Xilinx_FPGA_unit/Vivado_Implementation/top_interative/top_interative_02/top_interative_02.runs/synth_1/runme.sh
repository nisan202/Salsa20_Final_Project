...
HD_PWD='C:/Users/HP/Desktop/Degree/Nisan_final_project/vivado_implementation/top_interative_02/top_interative_02.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_salsa_xilinx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_salsa_xilinx.tcl
