...
HD_PWD='C:/Users/HP/Desktop/Degree/Nisan_final_project/vivado_implementation/top_interative_02/top_interative_02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_salsa_xilinx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_salsa_xilinx.tcl -notrace
